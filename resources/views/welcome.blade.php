...
<head>
    ...
    <title>Harrison Lin's Cat 125 Portfolio</title>
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Harrison Lin</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Harrison Lin</span>
                        <hr class="star-light">
    ...
    <section id="links">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <p>Making a website that fits your vision doesn't just happen after reading a tutorial. Website development is complicated because many components are required to support a website's architecture. Check out some of the resources that were used in the creation of this website.</p>
                </div>
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a href="/links" class="btn btn-lg links-button">
                        Visit More Sites
                    </a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="footer-col col-md-12">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="https://www.facebook.com/vaiolis" class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                            </li>
                            <li>
